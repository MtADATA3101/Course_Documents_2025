...
- At least one additional bug or problem described, using James
...
- Resolution of a second bug or problem

### Substantive contribution to project (A level)

- B level work, and a third bug reported and resolved OR
...
## In progress (discuss availability for completion)
...
- Approaches to find new ideas for bugs:
  ...
  - Look at the dataframes created by the code. Does it match what you
    expect based on the comments? Are there unexpected columns, values,
    or a lot of unexpected NAs? Report it.
...
- Test the code using method 2 with [additional Ringgold
  ...
  - Describe the differences in a bug.
