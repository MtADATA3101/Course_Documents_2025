...
Scraping the whole page in this way isn't very effective. We get a list of two (node and doc) with external pointers.
...
The flight data on the Moncton airport website is an example of a dynamic element.
